...
#toggle hidden
alias togglehiddenON='defaults write com.apple.Finder AppleShowAllFiles -bool true && killall Finder'
alias togglehiddenOFF='defaults write com.apple.Finder AppleShowAllFiles -bool false && killall Finder'
